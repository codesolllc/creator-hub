...
const VerifyThankyou = ({ navigation }) => {
      ...
      <View style={styles.container}>
        <View style={styles.thankyou_container}>
          ...
          <Text style={styles.thankyou_decs}>
            Your payment for {" "}
            <Text style={styles.highlighted}>verification</Text>, amounting to{" "}
            <Text style={styles.highlighted}>$1000</Text>, has been successfully
            processed.
          </Text>
        </View>
