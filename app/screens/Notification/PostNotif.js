...
import { useGetPostNotifsQuery } from "../../Redux/Reducers/Notification";
import AsyncStorage from "@react-native-async-storage/async-storage";
import { useEffect, useState } from "react";

function PostNotif({ navigation }) {
  ...
  const notifications = useGetPostNotifsQuery(userData?.findUser?._id, {
    skip: !userData?.findUser?._id,
  });

  const NavigateFromNotification = (post) => {
    navigation.navigate("SinglePost", { post: post?.postID });
  };
