...
const CategoryUpdateModal = ({ setShowModal, data, refresher }) => {
  ...
  const onSumbitCategory = async (e) => {
    ...
    if (productField.category_name) {
      ...
      formData.append("category_name", productField?.category_name);
      ...
      try {
        const res = await axiosInstance.patch(
          `/product_categories/update_categories/${data?._id}`,
          formData,
          {
            headers: {
